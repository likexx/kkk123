...
type DdddClient interface {
	...
	TestFunc2(ctx context.Context, in *NewHelloRequest, opts ...grpc.CallOption) (*HelloReply, error)
}
...
func (c *ddddClient) TestFunc2(ctx context.Context, in *NewHelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/ddd.fff.dddd/TestFunc2", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DdddServer interface {
	...
	TestFunc2(context.Context, *NewHelloRequest) (*HelloReply, error)
...
func (UnimplementedDdddServer) TestFunc2(context.Context, *NewHelloRequest) (*HelloReply, error) {
...
func _Dddd_TestFunc2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewHelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DdddServer).TestFunc2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ddd.fff.dddd/TestFunc2",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DdddServer).TestFunc2(ctx, req.(*NewHelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Dddd_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Dddd_TestFunc2_Handler,
		},
	},
