...
type AaaaaaClient interface {
	SayHello2468(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error)
}
...
func (c *aaaaaaClient) SayHello2468(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/todo1.ddd.aaaaaa/SayHello2468", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AaaaaaServer interface {
	SayHello2468(context.Context, *HelloRequest) (*HelloReply, error)
...
func (UnimplementedAaaaaaServer) SayHello2468(context.Context, *HelloRequest) (*HelloReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SayHello2468 not implemented")
}
...
func _Aaaaaa_SayHello2468_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AaaaaaServer).SayHello2468(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo1.ddd.aaaaaa/SayHello2468",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AaaaaaServer).SayHello2468(ctx, req.(*HelloRequest))
	}
...
var Aaaaaa_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SayHello2468",
			Handler:    _Aaaaaa_SayHello2468_Handler,
		},
	},
