...
type CccccClient interface {
	TestHello1234(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error)
}
...
func (c *cccccClient) TestHello1234(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/adfadsf.ffff.ccccc/TestHello1234", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CccccServer interface {
	TestHello1234(context.Context, *HelloRequest) (*HelloReply, error)
...
func (UnimplementedCccccServer) TestHello1234(context.Context, *HelloRequest) (*HelloReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TestHello1234 not implemented")
}
...
func _Ccccc_TestHello1234_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CccccServer).TestHello1234(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/adfadsf.ffff.ccccc/TestHello1234",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CccccServer).TestHello1234(ctx, req.(*HelloRequest))
	}
...
var Ccccc_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "TestHello1234",
			Handler:    _Ccccc_TestHello1234_Handler,
		},
	},
